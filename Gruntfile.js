// Generated on 2014-07-31 using generator-ionic 0.4.1
'use strict';
    ...
    karma: {
      options: {
        ...
        files: [
          ...
          '<%= yeoman.app %>/bower_components/mockfirebase/dist/mockfirebase.js',
          '<%= yeoman.app %>/bower_components/angularfire/dist/angularfire.min.js',
          '<%= yeoman.app %>/bower_components/sugar/release/sugar.min.js',
          '<%= yeoman.app %>/bower_components/angular-gestures/gestures.js',
          '<%= yeoman.app %>/<%= yeoman.scripts %>/**/*.js',
          // 'test/mock/**/*.js',
          'test/spec/**/*.js'
        ],
